...
def main():
    st.set_page_config(
        page_title="YC Dynamics / AI-Powered Document Search & Summarizer",
        page_icon="📄",
        layout="wide",
    )
    ...
    st.markdown(
        """
        <h1>📄 AI-Powered Document Search & Summarizer</h1>
        <h2>YC Dynamics (Yacine Fares, Clément Philbert)</h2>
